...
RSpec.describe AddressesController, type: :controller do
  ...
  describe "GET show" do
    ...
    it "assigns the requested address as @address" do
      get :show, params: {trip_id: address.trip.to_param}, session: valid_session
  ...
  describe "PUT update" do
    ...
    describe "with valid params" do
      it "updates the requested Address" do
        put :update, params: {:trip_id => address.trip.to_param}.update(json_api_params(Address, new_attributes)), session: valid_session
        address.reload
    ...
    describe "with invalid params" do
      it "assigns the address as @address" do
        put :update, params: {:trip_id => address.trip.to_param}.update(
  ...
  describe "DELETE destroy" do
    ...
    it "destroys the requested address" do
      expect {
        delete :destroy, params: {:trip_id => address.trip.to_param}, session: valid_session
      }.to change(Address, :count).by(-1)
    end
  end
end
