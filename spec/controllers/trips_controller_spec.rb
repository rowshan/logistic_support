...
RSpec.describe TripsController, type: :controller do
  ...
  describe "POST create" do
    ...
    describe "with valid params" do
      it "creates a new Trip" do
        expect {
          post :create, params: {:trip_kind_id => trip_kind.to_param}.merge(json_api_params(Trip, attributes_for(:trip).update(:trip_kind_id => trip_kind.to_param))), session: valid_session
        }.to change(Trip, :count).by(1)
      end

      it "assigns a newly created trip as @trip" do
        post :create, params: {:trip_kind_id => trip_kind.to_param}.merge(json_api_params(Trip, attributes_for(:trip).update(:trip_kind_id => trip_kind.to_param)))
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved trip as @trip" do
        post :create, params: json_api_params(Trip, attributes_for(:trip).update(trip_kind_id: nil, order_id: nil, date: nil, time_window_id: nil, address_id: nil)), session: valid_session
  ...
  describe "PUT update" do
    let!(:trip_kind) { create :trip_kind }
    let!(:trip) { create :trip }
    let(:new_attributes) { attributes_for(:trip).update(:trip_kind_id=> trip.trip_kind.to_param) }
    describe "with valid params" do
      it "updates the requested Trip" do
        put :update, params: { :trip_kind_id => trip_kind.to_param,:id => trip.to_param}.update(json_api_params(Trip, new_attributes)), session: valid_session
        trip.reload
        p trip.inspect
        p trip.errors
  ...
  describe "with invalid params" do
    it "assigns the time_window as @trip" do
      put :update, params:{ :trip_kind_id => trip.trip_kind.to_param,:id => trip.to_param}.update(
